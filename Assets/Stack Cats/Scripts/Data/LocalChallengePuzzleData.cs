...
{
    [Serializable]
    public class LocalChallengePuzzleData : IChallengePuzzleData
    {
        ...
        public bool WasLuckPotionUsed { get { return _wasLuckPotionUsed; } set { _wasLuckPotionUsed = value; } }
        ...
        private bool _wasLuckPotionUsed;
        ...
        public LocalChallengePuzzleData(string puzzleJsonData, int difficultyRating, int minMoves, int maxMoves, int numUndos)
        {
