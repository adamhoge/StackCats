...
{
    public static class JungleFlavoredPuzzleBuilder
    {
        /// <summary>
        ...
        public static JungleFlavoredPuzzleModel BuildToModel(JungleFlavoredPuzzle puzzle)
        {
            JungleFlavoredPuzzleModel puzzleModel = new JungleFlavoredPuzzleModel();
